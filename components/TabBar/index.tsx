...
function TabBar() {
  ...
  return (
    <div className="fixed bottom-0 w-full mx-auto max-w-screen-md grid grid-cols-5 border-neutral-600 bg-neutral-800 border-t px-5 py-3 *:text-white">
      ...
      <Link href="/live-shopping" className="flex flex-col items-center gap-px">
